#!/usr/bin/env python3
"""Profile one upstream continuation, never promote its checkpoint.
...
Opt-in --updates/--snapshot-mode run a retained, hash-pinned experiment; without
them the upstream trainer is executed unmodified.
"""
